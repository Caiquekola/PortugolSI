programa
{
	...
	funcao inicio()
	{
		...
		inteiro quantosN, numeroIntervalo, contador=1, intervalo1=0,intervalo2=0,intervalo3=0,intervalo4=0
		...
		escreva("\nA quantidade de números no intervalo [0,25] é de "+intervalo1+" números")
		escreva("\nA quantidade de números no intervalo ]25,50] é de "+intervalo2+" números")
		escreva("\nA quantidade de números no intervalo ]50,75] é de "+intervalo3+" números")
		escreva("\nA quantidade de números no intervalo ]75,100] é de "+intervalo4+" números")
